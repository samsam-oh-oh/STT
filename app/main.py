...
async def get_transcription():
    if os.path.exists(SAVE_PATH):
        return FileResponse(SAVE_PATH, media_type="text/plain", filename="transcription.txt")
    return {"error": "No transcription found. Please run POST /transcribe-audio/ first."}